  ...
  if (companies.length === 0) {
    ...
    await performQuery(`
      INSERT INTO company_profiles (
        ...
        'https://google.com', 'hr@talentbridge.com', '9876543210', 'Private Limited', 'Information Technology', '500-1000',
    ...
    console.log("🏢 Default approved company created: company@talentbridge.com / company123");
  }
