...
// 7. Placed Student Discovery Gallery (Mock Candidates Pre-seeded for rich discovery experience)
router.get("/success-gallery", authenticate, async (req: any, res) => {
  try {
    ...
    // In case no candidates are premium-seeded yet, let's return some elegant static/mock ones
    // plus the real database ones to make sure the library is loaded on first visit!
    const fallbackList = [
      {
        id: 991, name: "Arjun Mehta", tb_id: "TB-2026-10482", photo: "", company: "Amazon",
        skills: ["Java", "Spring Boot", "React", "Docker", "AWS", "MySQL"], is_top_performer: 1
      },
      {
        id: 992, name: "Sneha Nair", tb_id: "TB-2026-18751", photo: "", company: "Google",
        skills: ["Python", "Golang", "Kubernetes", "PostgreSQL", "C++"], is_top_performer: 1
      },
      {
        id: 993, name: "Rohan Das", tb_id: "TB-2026-24590", photo: "", company: "Infosys",
        skills: ["Java", "SQL", "JavaScript", "HTML", "CSS"], is_top_performer: 0
      },
      {
        id: 994, name: "Priya Sharma", tb_id: "TB-2026-30128", photo: "", company: "TCS",
        skills: ["Python", "Data Science", "SQL", "Tableau", "R"], is_top_performer: 0
      },
      {
        id: 995, name: "Aditya Verma", tb_id: "TB-2026-45529", photo: "", company: "Accenture",
        skills: ["React Native", "Node.js", "Express", "MongoDB", "Redux"], is_top_performer: 1
      },
      {
        id: 996, name: "Meera Sen", tb_id: "TB-2026-58321", photo: "", company: "Wipro",
        skills: ["Manual Testing", "Selenium", "Java", "TestNG"], is_top_performer: 0
      }
    ];

    const results = placed.length > 0 ? placed.map((p: any) => ({
      id: p.id,
      name: p.name,
      tb_id: p.tb_id,
      photo: p.photo,
